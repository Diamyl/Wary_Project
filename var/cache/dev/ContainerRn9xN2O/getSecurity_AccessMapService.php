...
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/ajoutsystem'), [0 => 'ROLE_SUPERADMIN'], NULL);
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/ajoutpartenaire'), [0 => 'ROLE_SUPERADMIN'], NULL);
